 ...
 * Requires: 1.2.2+
 */
(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else{if(typeof exports==="object"){module.exports=a}else{a(jQuery)}}}(function(e){var d=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"];var g="onwheel" in document||document.documentMode>=9?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"];var f,a;if(e.event.fixHooks){for(var b=d.length;b;){e.event.fixHooks[d[--b]]=e.event.mouseHooks}}e.event.special.mousewheel={setup:function(){if(this.addEventListener){for(var h=g.length;h;){this.addEventListener(g[--h],c,false)}}else{this.onmousewheel=c}},teardown:function(){if(this.removeEventListener){for(var h=g.length;h;){this.removeEventListener(g[--h],c,false)}}else{this.onmousewheel=null}}};e.fn.extend({mousewheel:function(h){return h?this.bind("mousewheel",h):this.trigger("mousewheel")},unmousewheel:function(h){return this.unbind("mousewheel",h)}});function c(h){var i=h||window.event,n=[].slice.call(arguments,1),p=0,k=0,j=0,m=0,l=0,o;h=e.event.fix(i);h.type="mousewheel";if(i.wheelDelta){p=i.wheelDelta}if(i.detail){p=i.detail*-1}if(i.deltaY){j=i.deltaY*-1;p=j}if(i.deltaX){k=i.deltaX;p=k*-1}if(i.wheelDeltaY!==undefined){j=i.wheelDeltaY}if(i.wheelDeltaX!==undefined){k=i.wheelDeltaX*-1}m=Math.abs(p);if(!f||m<f){f=m}l=Math.max(Math.abs(j),Math.abs(k));if(!a||l<a){a=l}o=p>0?"floor":"ceil";p=Math[o](p/f);k=Math[o](k/a);j=Math[o](j/a);n.unshift(h,p,k,j);return(e.event.dispatch||e.event.handle).apply(this,n)}}));(function(b){var a={init:function(c){var d={top:"auto",autoOpen:false,overlayOpacity:0.5,overlayColor:"#000",overlayClose:true,overlayParent:"body",closeOnEscape:true,closeButtonClass:".close",onOpen:false,onClose:false};c=b.extend(d,c);return this.each(function(){var g=c;var e=b('<div class="lean-overlay"></div>');e.css({display:"none",position:"fixed","z-index":200,top:0,left:0,height:100+"%",width:100+"%",background:g.overlayColor,opacity:g.overlayOpacity}).appendTo(g.overlayParent);var f=b(this);f.css({display:"none",position:"fixed","z-index":201,left:50+"%",top:parseInt(g.top)>-1?g.top+"px":50+"%"});f.bind("openModal",function(){b(this).css({display:"block","margin-left":-(f.outerWidth()/2)+"px","margin-top":(parseInt(g.top)>-1?0:-(f.outerHeight()/2))+"px"});e.fadeIn(200,function(){if(g.onOpen&&typeof(g.onOpen)==="function"){g.onOpen(f[0])}})});f.bind("closeModal",function(){b(this).css("display","none");e.fadeOut(200,function(){if(g.onClose&&typeof(g.onClose)==="function"){g.onClose(f[0])}})});e.click(function(){if(g.overlayClose){f.trigger("closeModal")}});b(document).keydown(function(h){if(g.closeOnEscape&&h.keyCode==27){f.trigger("closeModal")}});f.on("click",g.closeButtonClass,function(h){f.trigger("closeModal");h.preventDefault()});if(g.autoOpen){f.trigger("openModal")}})}};b.fn.easyModal=function(c){if(a[c]){return a[c].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof c==="object"||!c){return a.init.apply(this,arguments)}else{b.error("Method "+c+" does not exist on jQuery.easyModal")}}}})(jQuery);
