		...
		<form:form commandName="partnership" htmlEscape="true" method="post" action="${cp }/help/partnership.jt">
			...
			<footer class="jt-partnership-article-footer">
				<ul>
					...
					<li>미러스에 입점하신 경우 <a href="${cp }/businessUtilizationAgree">이용약관</a> 및 <a href="${cp }/businessInfoPolicy">개인정보취급방침</a>에 동의한 것으로 간주합니다. </li>
					<li style="list-style: none; text-align: center; margin-top: 10px;"><input type="button" value="문의하기" class="jt-partnership-submit jt-btn-orange" id="jt-partnership-btn"/></li>
				</ul>
			</footer>
		</form:form>
	</article>
