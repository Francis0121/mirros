...
public class JtownUser implements UserDetails, CredentialsContainer {
     ...
     */
    public JtownUser(String username, String password, boolean enabled, boolean accountNonExpired,
     ...
     */
    public JtownUser(String username, String password, Collection<? extends GrantedAuthority> authorities) {
