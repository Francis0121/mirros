	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
    		...
    		return this.each(function() {
				...
				$(obj).height(objWidth);
				$('img', obj).width(objWidth).height(objWidth);
				var imgHeight = objWidth;
				var imgWidth = objWidth;
				...
				html = '<a href="javascript:void(0);"><span id="pause_btn'+randID+'" class="mm-carousel-pause">Pause</span></a>';
				html += '<a href="javascript:void(0);"><span id="play_btn'+randID+'" class="mm-carousel-play">Play</span></a>';
				$(obj).append(html);
